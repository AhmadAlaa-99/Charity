...
@endsection
@section('title')
    جمعية الدعوة بالمزاحمية - المستخدمين
@stop
@section('content')
    @if (session('success'))
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a href="javascript:void(0)">السمتخدمين</a></li>
                <li class="breadcrumb-item"><a href="javascript:void(0)">كافة مستخدمي لوحة التحكم</a></li>
            </ol>
        </div>
        <div class="d-flex flex-wrap align-items-center mb-3">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="javascript:void(0);" data-bs-toggle="tab" id="transaction-tab"
                                data-bs-target="#Resturants" role="tab">السمتخدمين</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <a href="javascript:void()" data-bs-toggle="modal" data-bs-target="#add" class="btn btn-outline-primary mb-3"><i
                    class="fa fa-add me-3 scale3"></i>اضافة مستخدم
            </a>
        </div>
        <div class="row">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <a href="#" class="btn btn-danger shadow btn-xs sharp"
                                                    onclick="event.preventDefault();
                                                     document.getElementById('destroy-form-{{ $user->id }}').submit();"><i
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('admin.users.store') }}" autocomplete="off"
                        ...
                        <div class="row">
                            ...
                            <div class="input-group mb-3">
                                <label class="col-lg-4 col-form-label" for="validationCustom01">البريد الالكتروني
                                    <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
                            ...
                            <div class="input-group mb-3">
                                <label class="col-lg-4 col-form-label" for="validationCustom01">كلمة السر
                                    <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
                            ...
                            <div class="input-group mb-3">
                                <label class="col-lg-4 col-form-label" for="validationCustom01">تأكيد كلمة السر
                                    <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
                            ...
                            <div class="input-group mb-3">
                                <label class="col-lg-4 col-form-label" for="validationCustom01">الدور
                                    <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
                                    <select class="default-select wide form-control" name="roleName"
