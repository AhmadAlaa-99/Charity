...
@endsection
@section('title')
    جمعية الدعوة بالمزاحمية - الاحصائيات
@stop
@section('content')
    <!-- row -->
    <div class="container-fluid">
        <div class="row invoice-card-row">
            <div class="col-xl-4 col-xxl-3 col-sm-6">
                <div class="card bg-warning invoice-card" style="background-color: #000">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ \App\Models\User::count() }}</h2>
                            <span class="text-white fs-18">مدراء الموقع</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-xxl-3 col-sm-6">
                <div class="card bg-info invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ \App\Models\Council::count() }}</h2>
                            <span class="text-white fs-18">اجتماعات المجلس</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-xxl-3 col-sm-6">
                <div class="card bg-secondary invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ \App\Models\Event::count() }}</h2>
                            <span class="text-white fs-18">الفعاليات</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-xxl-3 col-sm-6">
                <div class="card bg-info invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ \App\Models\Employee::count() }}</h2>
                            <span class="text-white fs-18">الموظفين</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-xxl-3 col-sm-6">
                <div class="card bg-success invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ \App\Models\Governance::count() }}</h2>
                            <span class="text-white fs-18">الحوكمة</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-xxl-3 col-sm-6">
                <div class="card bg-info invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ \App\Models\News::count() }}</h2>
                            <span class="text-white fs-18">الأخبار</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-xxl-3 col-sm-6">
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ \App\Models\Partner::count() }}</h2>
                            <span class="text-white fs-18">الشركاء</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-xxl-3 col-sm-6">
                <div class="card bg-info invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ \App\Models\Project::count() }}</h2>
                            <span class="text-white fs-18">المشاريع</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-xxl-3 col-sm-6">
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ \App\Models\umrah::count() }}</h2>
                            <span class="text-white fs-18">حملات العمرة الكلية</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-xxl-3 col-sm-6">
                <div class="card bg-info invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ \App\Models\umrah::where('status','متاحة')->count() }}</h2>
                            <span class="text-white fs-18">الحملات المتاحة للتسجيل</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-xxl-3 col-sm-6">
                <div class="card bg-warning invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ \App\Models\muamtari::where('status','pending')->count() }}</h2>
                            <span class="text-white fs-18">طلبات الترشيح</span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-xxl-3 col-sm-6">
                <div class="card bg-info invoice-card">
                    <div class="card-body d-flex">
                        ...
                        <div>
                            <h2 class="text-white invoice-num">{{ \App\Models\muamtari::where('status','done')->count() }}</h2>
                            <span class="text-white fs-18">عدد المعتمرين</span>
                        </div>
                    </div>
                </div>
            </div>
