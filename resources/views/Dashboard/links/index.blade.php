...
@endsection
@section('title')
    جمعية الدعوة بالمزاحمية - روابط صديقة
@stop
@section('content')
    @if (session('success'))
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">كافة الروابط</a></li>
            </ol>
        </div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="javascript:void(0);" data-bs-toggle="tab" id="transaction-tab"
                                data-bs-target="#Resturants" role="tab">روابط صديقة</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($links as $link)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-nowrap">{{ $link->link }}</span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="javascript:void(0);"
                                                    ...
                                                    data-bs-toggle="modal" data-id="{{ $link->id }}"
                                                    data-name="{{ $link->name }}" data-link="{{ $link->link }}"
                                                    data-bs-target="#edit" >
                                                ...
                                                <a href="#" class="btn btn-danger shadow btn-xs sharp"
                                                    onclick="event.preventDefault();
                                                     document.getElementById('destroy-form-{{ $link->id }}').submit();"><i
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('admin.links.store') }}" autocomplete="off"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit').click(function() {
                ...
                var updateUrl = "{{ url('admin/links') }}/" + Id;
