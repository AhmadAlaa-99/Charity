                                            ...
                                            <label class="col-lg-2 col-form-label" for="validationCustom08"> النوع
                                             ...
                                             <div class="col-lg-10">
                                                <select class="default-select wide form-control" name="type">
                                                    ...
                                                    <option value="كلمة" {{ $event->type == "كلمة" ? 'selected' : '' }} >كلمة</option>
                                                    <option value="درس" {{ $event->type == "درس" ? 'selected' : '' }} >درس</option>
                                                    <option value="لقاء" {{ $event->type == "لقاء" ? 'selected' : '' }} >لقاء</option>
                                                    <option value="معرض" {{ $event->type == "معرض" ? 'selected' : '' }} >معرض</option>
                                                </select>
                                                @error('type')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
