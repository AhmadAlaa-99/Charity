...
@endsection
@section('title')
    جمعية الدعوة بالمزاحمية -  تفاصيل الحملة
@stop
@section('content')
    @if (session('success'))
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">تفاصيل الحملة</a></li>
            </ol>
        </div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="javascript:void(0);" data-bs-toggle="tab" id="transaction-tab"
                                data-bs-target="#Resturants" role="tab">تفاصيل الحملة</a>
                        </li>
                    </ul>
                </div>
            </div>
